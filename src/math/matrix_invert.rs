...
#[cfg(test)]
mod tests {
    use crate::math::{matrix::{Matrix, Matrix4x4}, matrix_transpose::MatrixTranspose};
    ...
    fn invert3() -> () {
        ...
        assert!(b.is_some());
        let bp = b.unwrap();
        let exp = vec![-0.04074, -0.07778, 0.14444, -0.22222, -0.07778, 0.03333, 0.36667, -0.33333,
    ...
    fn invert2() -> () {
        ...
        assert!(b.is_some());
        let bp = b.unwrap();
        let exp = vec![-0.15385, -0.15385, -0.28205, -0.53846, -0.07692, 0.12308, 0.02564, 0.03077,
    ...
    #[test]
    fn invert1() -> () {
        let a = Matrix4x4::new(-5., 2., 6., -8., 1., -5., 1., 8., 7., 7., -6., -7., 1., -3., 7., 4.);
        let b = a.invert();
        assert_eq!(a.det(), 532.);
